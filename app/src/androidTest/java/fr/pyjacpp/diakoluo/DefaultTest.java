...
public class DefaultTest extends Test {
    public DefaultTest() {
        ...
        setName("Les verbes anglais irréguliers");
        setDescription("C'est le test par défaut.");
        setCreatedDate(new Date(1581693710347L));
        setLastModificationDate(new Date(1581693710347L));
        setNumberTestDid(1);
