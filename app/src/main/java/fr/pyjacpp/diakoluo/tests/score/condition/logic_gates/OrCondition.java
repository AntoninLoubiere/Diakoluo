...
public class OrCondition extends BaseCondition {
    public static final String ATTRIBUTE_TYPE_VALUE = "or";
     ...
     */
    public OrCondition(BaseCondition condition1, BaseCondition condition2) {
     ...
     */
    public OrCondition(XmlPullParser parser, ColumnInputType inputType) throws IOException, XmlPullParserException {
    ...
    public ViewCreator getViewCreator() {
        return new ViewCreator(
                R.string.condition_or_name,
                R.string.condition_or_description,
                new BaseParameter[]{
                        new ConditionParameter(
                                R.string.condition_or_condition_name,
                                R.string.condition_or_condition_description,
                                condition1
                        ),
                        new ConditionParameter(
                                R.string.condition_or_condition_name,
