 ...
 * And gate
 */
public class XorCondition extends BaseCondition {
    public static final String ATTRIBUTE_TYPE_VALUE = "xor";
     ...
     */
    public XorCondition(BaseCondition condition1, BaseCondition condition2) {
     ...
     */
    public XorCondition(XmlPullParser parser, ColumnInputType inputType) throws IOException, XmlPullParserException {
    ...
    public ViewCreator getViewCreator() {
        return new ViewCreator(
                R.string.condition_xor_name,
                R.string.condition_xor_description,
                new BaseParameter[]{
                        new ConditionParameter(
                                R.string.condition_xor_condition_name,
                                R.string.condition_xor_condition_description,
                                condition1
                        ),
                        new ConditionParameter(
                                R.string.condition_xor_condition_name,
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof XorCondition) {
            XorCondition c = (XorCondition) obj;
